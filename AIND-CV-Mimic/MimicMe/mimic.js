...
function drawEmoji(canvas, img, face) {
  ...
  // <your code here>
  ctx.fillText(face.emojis.dominantEmoji, face.featurePoints[4].x, face.featurePoints[4].y);
}
...
// update score when successful mimic and generate next emoji
function scoring() {
...
// reset the score, total and mimic emoji when reset button is hit.
function reset() {
    score = 0;
    total = 0;
    targetEmoji = generateEmoji();
